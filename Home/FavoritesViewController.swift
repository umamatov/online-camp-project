...
class FavoritesViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    private let tableView: UITableView = {
        ...
        table.register(CustomOrderCell1.self,
...
//        tableView.contentInset = UIEdgeInsets(top: 10, left: 0, bottom: 50, right: 0)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cell1",for: indexPath) as! CustomOrderCell1
        return cell
    }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let controller = Home4ViewController()
